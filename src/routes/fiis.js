...
router.get('/benchmark', authMiddleware, async (req, res) => {
  ...
  try {
    ...
    // CDI mensal por período (Selic meta ÷ 12, ajustado ao mês vigente)
    // Fonte: decisões COPOM históricas
    const SELIC_MENSAL = {
      '2021-01': 0.0015, '2021-02': 0.0015, '2021-03': 0.0017, '2021-04': 0.0021,
      '2021-05': 0.0027, '2021-06': 0.0031, '2021-07': 0.0036, '2021-08': 0.0043,
      '2021-09': 0.0049, '2021-10': 0.0049, '2021-11': 0.0059, '2021-12': 0.0073,
      '2022-01': 0.0073, '2022-02': 0.0076, '2022-03': 0.0091, '2022-04': 0.0091,
      '2022-05': 0.0102, '2022-06': 0.0102, '2022-07': 0.0108, '2022-08': 0.0108,
      '2022-09': 0.0108, '2022-10': 0.0108, '2022-11': 0.0108, '2022-12': 0.0108,
      '2023-01': 0.0108, '2023-02': 0.0108, '2023-03': 0.0108, '2023-04': 0.0108,
      '2023-05': 0.0108, '2023-06': 0.0108, '2023-07': 0.0108, '2023-08': 0.0102,
      '2023-09': 0.0102, '2023-10': 0.0098, '2023-11': 0.0098, '2023-12': 0.0094,
      '2024-01': 0.0094, '2024-02': 0.0091, '2024-03': 0.0091, '2024-04': 0.0088,
      '2024-05': 0.0088, '2024-06': 0.0085, '2024-07': 0.0085, '2024-08': 0.0085,
      '2024-09': 0.0085, '2024-10': 0.0085, '2024-11': 0.0085, '2024-12': 0.0094,
      '2025-01': 0.0100, '2025-02': 0.0108, '2025-03': 0.0108, '2025-04': 0.0116,
      '2025-05': 0.0116, '2025-06': 0.0116, '2025-07': 0.0116, '2025-08': 0.0116,
      '2025-09': 0.0116, '2025-10': 0.0116, '2025-11': 0.0116, '2025-12': 0.0116,
      '2026-01': 0.0116, '2026-02': 0.0116, '2026-03': 0.0116, '2026-04': 0.0116,
      '2026-05': 0.0116, '2026-06': 0.0116, '2026-07': 0.0116,
    };

    function getCdiMensal(mes) {
      return SELIC_MENSAL[mes] ?? 0.0100;
    }
    // Poupança: 0.5%/mês + TR (~0%) quando Selic > 8.5%
    // 70% da Selic quando Selic <= 8.5%
    function getPoupMensal(mes) {
      const cdi = getCdiMensal(mes);
      return cdi > 0.0069 ? 0.005 : cdi * 0.7;
    }
